      ...
      <Container fluid className="p-4">
        <Row className="mb-4">
          ...
          <Col md={6}>
            ...
            >
              <CardBody>
                  <h6 className="mb-4" style={{ fontSize: "18px", color: "#101828", fontWeight: 500 }}>
                    Winning Percentage
                  </h6>
                  <div className="d-flex">
                    <div style={{ position: "relative", width: "50%", height: 200 }}>
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                            data={[
                              { name: "Wins", value: 98, fill: "#FFD600" },
                              { name: "Losses", value: 2, fill: "#E1E1E1" },
                            ]}
                            cx="50%"
                            cy="50%"
                            innerRadius={60}
                    ...
                    <div className="mb-4">
                      <div className="d-flex align-items-center gap-2 mb-2">
                        ...
                        <span style={{ color: "#101828", fontSize: "16px", fontWeight: "500", marginLeft: "auto" }}>
                          1,230
                        </span>
                      </div>
