            ...
            {activeTab === "brackets" && (
              <div className={styles.bracketsContainer}>
                <div className={styles.round}>
                  <div>
                    <h6 className="mb-3 text-muted">ROUND 1</h6>
                    <div className={styles.bracketMatches}>
                      <div className={styles.bracketMatch}>
                        <div className={styles.matchDetails}>
                          <div className={`${styles.team} ${styles.won}`}>
                            <span className={styles.teamName}>Scorpio</span>
                            <span className={styles.result}>L</span>
                          </div>
                          <div className={`${styles.team} ${styles.lost}`}>
                            <span className={styles.teamName}>BeeHives</span>
                            <span className={styles.result}>W</span>
                          </div>
                        </div>
                  ...
                  <div>
                    <h6 className="mb-3 text-muted">ROUND 2</h6>
                    <div className={styles.bracketMatches}>
                      <div className={styles.bracketMatch}>
                        <div className={styles.matchDetails}>
                          <div className={`${styles.team} ${styles.won}`}>
                  ...
                  <div>
                    <h6 className="mb-3 text-muted">ROUND 3</h6>
                    <div className={styles.bracketMatches}>
                      <div className={styles.bracketMatch}>
                        <div className={styles.matchDetails}>
                          <div className={`${styles.team} ${styles.won}`}>
