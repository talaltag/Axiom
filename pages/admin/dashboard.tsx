...
export default function AdminDashboard() {
  ...
  const messages = [
    { name: 'Dianne Team', message: 'Im facing a issue with my teammates.', time: '9:13 AM' },
    { name: 'Dianne Team', message: 'Im facing a issue with my teammates.', time: '9:13 AM' },
    { name: 'Dianne Team', message: 'Im facing a issue with my teammates.', time: '9:13 AM' },
    { name: 'Dianne Team', message: 'Im facing a issue with my teammates.', time: '9:13 AM' },
  ];
              ...
              <Card className="mb-4">
                <CardBody>
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <Chart options={lineChartOptions} series={[{ data: [25, 66, 41, 89, 63, 25, 44, 12, 36, 9, 54] }]} type="line" width={60} height={30} />
                  </div>
                ...
                <div className="messages-list">
                  {messages.map((msg, index) => (
                    <div key={index} className="d-flex align-items-center mb-3">
                      <div className="me-3">
                        <Image src="/axiom.png" alt={msg.name} width={40} height={40} className="rounded-circle" />
                      </div>
            ...
            <Card className="mb-4">
              <CardBody>
                ...
                <Chart
                  ...
                  series={[
                    { name: 'Active', data: [65, 59, 80, 81, 56, 55, 40, 60, 70, 75, 80, 85] },
                    { name: 'Pending', data: [28, 48, 40, 19, 86, 27, 90, 50, 60, 65, 70, 75] },
                    { name: 'Completed', data: [45, 55, 65, 70, 75, 80, 85, 90, 92, 95, 97, 100] },
                    { name: 'Cancelled', data: [15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70] }
                  ]}
                  type="line"
                  height={350}
                />
